...
`define FUNCT_ADD   6'b10000x
`define FUNCT_SUB   6'b10001x
...
`define ALU_OP_RTYPE   4'b0000
`define ALU_OP_ADD     4'b0001
`define ALU_OP_AND     4'b0010
`define ALU_OP_OR      4'b0011
`define ALU_OP_XOR     4'b0100
`define ALU_OP_LUI     4'b0101
`define ALU_OP_BRANCH  4'b0110
`define ALU_OP_SLT     4'b0111
`define ALU_OP_SLTU    4'b1000
